...
const FyersCredential: FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get(`${apiUrl}/fyers/appcredential/get`, {
          headers: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`${apiUrl}/fyers/appcredential/create`, reqData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token") || ""}`,
          "AngelOneToken": localStorage.getItem("angel_token") || "",
        },
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8 lg:p-10">
          <div className="w-full">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Fyers Credentials</h2>
              <p className="text-sm text-gray-500 mt-1">
                Configure your Fyers API credentials
              </p>
              {isSaved && (
...
export default FyersCredential;