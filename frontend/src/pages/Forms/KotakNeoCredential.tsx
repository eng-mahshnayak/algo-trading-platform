...
useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
            ...
            let res = await axios.post(`${apiUrl}/kotakneo/appcredential/create`, reqData, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token") || ""}`,
                        "AngelOneToken": localStorage.getItem("angel_token") || "",
                    },
      ...
      <div className="w-full p-6 bg-white rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700">
        ...
        <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" onSubmit={handleSubmit}>
          ...
          {/* Client Id */}
            ...
            >
               Client Code (ucc) <span className="text-error-500">*</span>
            </Label>
            ...
            <Label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
             Access Token  <span className="text-error-500">*</span>
            </Label>
            <div className="relative">
              <Input
                type="text"
          ...
          <div>
            <Label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
              MP IN <span className="text-error-500">*</span>
            </Label>
            <div className="relative">
              <Input
