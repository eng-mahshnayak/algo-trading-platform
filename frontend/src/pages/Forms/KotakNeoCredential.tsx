...
const KotakNeoCredential: FC = () => {
  ...
  const fetchKotakNeo = async () => {
    try {
      const res = await axios.get(`${apiUrl}/kotakneo/appcredential/get`, {
        headers: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`${apiUrl}/kotakneo/appcredential/create`, reqData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token") || ""}`,
          "AngelOneToken": localStorage.getItem("angel_token") || "",
        },
      ...
      if (res.data.status == true) {
        ...
        setIsSaved(true);
        // Clear fields after save if needed
        // setClientId("");
        // setTotpSecret("");
        // setApiKey("");
        // setPin("");
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8 lg:p-10">
          <div className="w-full">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Kotak Neo Credentials</h2>
              <p className="text-sm text-gray-500 mt-1">
                Configure your Kotak Neo API credentials
              </p>
              {isSaved && (
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Enter your MP IN (TOTP Secret)"
                    required
                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl 
                             text-gray-900 placeholder-gray-400
                             focus:ring-2 focus:ring-[#FB3800]/20 focus:border-[#FB3800] 
...
export default KotakNeoCredential;