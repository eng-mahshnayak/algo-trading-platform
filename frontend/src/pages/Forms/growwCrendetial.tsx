...
const GrowwCredential: FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`${apiUrl}/groww/appcredential/create`, reqData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token") || ""}`,
          "AngelOneToken": localStorage.getItem("angel_token") || "",
        },
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8 lg:p-10">
          <div className="w-full">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Groww Credentials</h2>
              <p className="text-sm text-gray-500 mt-1">
                Configure your Groww API credentials
              </p>
              {isSaved && (
...
export default GrowwCredential;