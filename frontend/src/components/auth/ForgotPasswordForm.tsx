              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#FB3800]/10 rounded-full border border-[#FB3800]/20">
                    ...
                    <span className="text-xs font-mono text-[#FB3800] tracking-wider font-semibold">RESET PASSWORD</span>
                  </div>
                  ...
                  <p className="text-gray-600 text-base leading-relaxed">
                    Don't worry! We'll help you reset your password and get back to your AI trading dashboard quickly.
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4">
                  <div className="flex items-center gap-3 text-gray-700 group hover:text-gray-900 transition-colors">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FB3800]/10 to-orange-50 flex items-center justify-center group-hover:scale-110 transition-transform">
                      <svg className="w-5 h-5 text-[#FB3800]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7.5a3 3 0 11-6 0 3 3 0 016 0zM9 11h6m-6 4h6M7.5 21h9a1.5 1.5 0 001.5-1.5v-9a1.5 1.5 0 00-1.5-1.5h-9A1.5 1.5 0 006 10.5v9A1.5 1.5 0 007.5 21z" />
                      </svg>
                    </div>
                    <div>
                      <p className="font-semibold">Secure Reset Process</p>
                      <p className="text-sm text-gray-500">Bank-level security verification</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 text-gray-700 group hover:text-gray-900 transition-colors">
                    ...
                    <div>
                      <p className="font-semibold">Instant Email Delivery</p>
                      <p className="text-sm text-gray-500">Receive code within seconds</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 text-gray-700 group hover:text-gray-900 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Get help anytime you need</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 pt-6 border-t border-gray-100">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-500">Average Reset Time</p>
                  </div>
                  <div className="text-center">
